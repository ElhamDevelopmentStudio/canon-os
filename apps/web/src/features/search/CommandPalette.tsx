...
export function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <DialogShell
      className="block bg-foreground/40 p-4 backdrop-blur-sm"
      initialFocusRef={inputRef}
      labelledBy="command-palette-title"
      onClose={onClose}
      panelClassName="mx-auto mt-16 w-full max-w-2xl overflow-hidden rounded-2xl border border-border bg-card p-0 shadow-2xl"
    >
